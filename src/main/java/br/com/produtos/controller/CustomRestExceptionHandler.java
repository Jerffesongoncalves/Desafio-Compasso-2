...
import br.com.produtos.model.ErrosModel;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex, WebRequest request) {
		...
		ErrosModel apiError = new ErrosModel(HttpStatus.BAD_REQUEST.value(), ex.getLocalizedMessage());
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ErrosModel error = new ErrosModel(HttpStatus.BAD_REQUEST.value(), errors.toString());
